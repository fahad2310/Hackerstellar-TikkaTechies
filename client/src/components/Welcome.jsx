        ...
        <div className='flex w-full justify-center items-center '>
            <div className='flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4'>
                <div className='flex flex-1 justify-start flex-col md:mr-10'>
                    <h1 className='text-3xl sm:text-5xl text-white texr-gradient py-1'>Track Goods <br />across the world</h1>
                    <p className='text-left mt-5 text-white font-white md:w-9/12 w-11/12 text-base'>
                        Explore the crypto world. Buy and sell crypto-curriencies easily on krypt.
                    </p>
                    <button
                      type='button'
                ...
                <div className='flex flex-col flex-1 items-center justify-start w-full md:mt-0 mt-10'>
                            ...
                            <div className='p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism'>
                                <Input placeholder="Adderss To " name="addressTo" type="text" handleChange = {()=>{}}/> 
